...
import { create_creds, create_user, getData, getTemplate, login, update_creds,test, signup, createTemplate, getApiTemplates } from "./src/services/apis/app.controller"
...
router.get("/getApiTemplates",getApiTemplates)
